...
<template>
  ...
  <div class="text-sm text-gray-900">
    ...
    <nav class="flex items-center px-4 py-3 bg-gray-900 justify-between">
      ...
      <div class="text-white flex items-center space-x-4">
        <a href="#">
          <a class="w-6 fill-current hover:text-gray-200" href="https://github.com/" data-hotkey="g d"
            ...
            data-hydro-click-hmac="5314f3046a145f005aea6a68c8114c2b22bcd7b1a188cab404230ed40375c35d">
      ...
      <!-- 右边 -->
      <div class="text-white flex items-center space-x-4 h-full">
        <a href="#" class="relative hover:text-gray-400">
          ...
          <div class="bg-blue-400 rounded-full w-2 h-2 absolute top-0 right-0"></div>
        </a>
    ...
    <!-- 标签图标 -->
    <div class="repo-stats bg-gray-100 flex flex-col lg:flex-row items-center justify-between px-8 py-4">
      <div class="flex">
        <svg aria-hidden="true" class="w-4 fill-current text-gray-600" viewBox="0 0 16 16" data-view-component="true"
          octicon color-icon-secondary mr-2>
          <path fill-rule="evenodd"
        ...
        <div class="flex items center text-xl ml-2">
          ...
          <a href="#" class="text-blue-600 hover:underline font-semibold">tailwindcss</a>
        </div>
      </div>

      <div class="flex space-x-2 mt-4 lg:mt-0">
        <div class="flex items-center justify-between text-xs">
          <button class="border border-gray-300 rounded px-3 py-1 flex items-center">
        ...
        <div class="flex text-xs">
          <button class="
                        ...
                        space-x-1
                    ">
            <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" class="w-5 h-5">
              <path fill-rule="evenodd"
    ...
    <div class="container mx-auto my-8 px-4 flex flex-col lg:flex-row">
      <div class="file-explorer-container w-full lg:w-3/4 lg:mr-8">
        ...
        <div
          class="commits-container bg-gray-100 rounded-md rounded-b-none border border-gray-300 border-b-0 flex items-center justify-between px-4 py-4 mt-5">
          <div class="flex items-center space-x-2">
          ...
          <div class="flex items-center">
            <svg class="w-4 h-4 fill-current text-green-700" aria-label="11 / 11 checks OK" role="img"
            ...
            <a href="#" class="hover:underline hover:text-blue-600 text-gray-600 ml-1 hidden lg:block">0e0d721</a>
            <a href="#" class="hover:underline hover:text-blue-600 text-gray-600 ml-1">2 days ago</a>
            <a class="flex items-center space-x-1 hover:text-blue-600 cursor-pointer ml-3">
              <svg class="w-4 h-4 fill-current" aria-hidden="true" viewBox="0 0 16 16" version="1.1"
                data-view-component="true">
                <path fill-rule="evenodd"
              ...
              <span class="font-semibold">4,242</span>
        ...
        <div class="file-explorer rounded-md rounded-t-none border border-gray-300 divide-y divide-gray-300">
          <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100">
            <div class="w-4/12 flex items-center">
              <svg class="w-4 h-4 fill-current text-blue-400" aria-label="Directory" aria-hidden="true" height="16"
            ...
            <div class="w-6/12 truncate">
              <a href="#" class="text-gray-600 hover:text-blue-600 hover:underline">Update release.yml</a>
            </div>
            <div class="w-2/12 text-right">
              <span class="text-gray-600">10 days ago</span>
            </div>
          </div>

          <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100">
            <div class="w-4/12 flex items-center">
              <svg class="w-4 h-4 fill-current text-gray-600" aria-label="File" aria-hidden="true" viewBox="0 0 16 16"
            ...
            <div class="w-6/12 truncate">
              <a href="#" class="text-gray-600 hover:text-blue-600 hover:underline">Convert new stuff to use ES6 modules
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Totam, expedita.</a>
            </div>
            <div class="w-2/12 text-right">
              <span class="text-gray-600">10 days ago</span>
            </div>
        ...
        <div class="flex items-center readme-container rounded-md rounded-b-none border border-gray-300 px-4 py-4 mt-4">
          <svg class="w-4 h-4 fill-current text-gray-600 mr-3" aria-hidden="true" viewBox="0 0 16 16" version="1.1"
            data-view-component="true">
            <path fill-rule="evenodd"
        ...
        <div class="rounded-md rounded-t-none border border-gray-300 border-t-0 px-6 py-6">
          <img alt="Tailwind CSS" width="350"
            src="https://camo.githubusercontent.com/76fc893540a16d0acb4967472a5195511ec64fd8d98f377cb00dc8fa73ffb67b/68747470733a2f2f7265666163746f72696e6775692e6e7963332e63646e2e6469676974616c6f6365616e7370616365732e636f6d2f7461696c77696e642d6c6f676f2d737469636b65722e737667"
            data-canonical-src="https://refactoringui.nyc3.cdn.digitaloceanspaces.com/tailwind-logo-sticker.svg"
            style="max-width: 100%;">
          <span>A utility-first CSS framework for rapidly building custom user interfaces.</span>
        </div>
      </div>

      <div class="sidebar w-full lg:w-1/4 mt-4 lg:mt-0">
        <div class="about">
          ...
          <div class="flex items-center space-x-2 mt-4">
            <svg class="w-4 fill-current" aria-hidden="true" viewBox="0 0 16 16" version="1.1"
              data-view-component="true">
              <path fill-rule="evenodd"
          ...
          <div class="tags text-xs font-semibold flex flex-wrap items-center mt-2">
            <a href="#" class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2">
              css
            </a>
            <a href="#" class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2">
              postcss
          ...
          <a class="flex items-center space-x-2 mt-4 group">
            <svg class="w-4 fill-current text-gray-600 group-hover:text-blue-600" aria-hidden="true" viewBox="0 0 16 16"
              version="1.1" data-view-component="true">
              <path fill-rule="evenodd"
        ...
        <div class="releases border-t border-gray-300 mt-6 pt-6">
          <h4 class="text-base font-semibold flex items-center">
            <span>Releases</span>
            <div class="text-xs rounded-lg bg-gray-100 text-gray-800 px-2 ml-1">163</div>
          </h4>

          <a href="#" class="flex items-start mt-4 group">
            <svg class="mt-1 w-4 fill-current text-green-500 group-hover:text-blue-500" aria-hidden="true"
              viewBox="0 0 16 16" version="1.1" data-view-component="true">
              <path fill-rule="evenodd"
                d="M2.5 7.775V2.75a.25.25 0 01.25-.25h5.025a.25.25 0 01.177.073l6.25 6.25a.25.25 0 010 .354l-5.025 5.025a.25.25 0 01-.354 0l-6.25-6.25a.25.25 0 01-.073-.177zm-1.5 0V2.75C1 1.784 1.784 1 2.75 1h5.025c.464 0 .91.184 1.238.513l6.25 6.25a1.75 1.75 0 010 2.474l-5.026 5.026a1.75 1.75 0 01-2.474 0l-6.25-6.25A1.75 1.75 0 011 7.775zM6 5a1 1 0 100 2 1 1 0 000-2z">
              </path>
            ...
            <span class="ml-2">
              <span class="font-semibold group-hover:text-blue-600">v2.2.6</span>
              <span
                class="ml-1 text-xs border border-green-500 text-green-600 rounded-full font-semibold inline-block px-2">Latest</span>
              <span class="block text-xs group-hover:text-blue-600">16 days ago</span>
            </span>
          </a>

          <div class="mt-4">
            <a href="#" class="text-blue-600 hover:underline">+ 162 releases</a>
          </div>
        </div>
        <!--end of releases-->
        ...
        <div class="packages border-t border-gray-300 mt-6 pt-6">
          ...
          <div class="mt-6">
            <span class="text-xs text-gray-600">No packages published</span>
          </div>
        </div>
        <!--end of packages-->
        ...
        <div class="used-by border-t border-gray-300 mt-6 pt-6">
          <h4 class="text-base font-semibold flex items-center">
            <span>Used by</span>
            <div class="text-xs rounded-lg bg-gray-100 text-gray-800 px-2 ml-1">320k</div>
          </h4>

          <div class="flex items-center mt-4">
            <a href="#" class="inline-flex items-center group -space-x-2">
              <div class="w-7 h-7 rounded-full bg-blue-500 border-2 border-white"></div>
              <div class="w-7 h-7 rounded-full bg-blue-500 border-2 border-white"></div>
              <div class="w-7 h-7 rounded-full bg-blue-500 border-2 border-white"></div>
              <div class="w-7 h-7 rounded-full bg-blue-500 border-2 border-white"></div>
              <div class="w-7 h-7 rounded-full bg-blue-500 border-2 border-white"></div>
            ...
            <span class="text-xs font-semibold text-blue-500 group-hover:underline ml-2 h-full"> + 320,428</span>
          </div>
        </div>
        <!--end of used by-->
        ...
        <div class="contributors border-t border-gray-300 mt-6 pt-6">
          <h4 class="text-base font-semibold flex items-center">
            ...
            <div class="text-xs rounded-lg bg-gray-100 text-gray-800 px-2 ml-1">201</div>
          </h4>
          ...
          <div class="mt-4">
            <span class="text-blue-500 hover:underline">+ 190 contributors</span>
          </div>
        </div>
        <!--end of contributors-->
        ...
        <div class="languages border-t border-gray-300 mt-6 pt-6">
          ...
          <div class="mt-4 flex">
            <div class="w-8/12 h-2 rounded-md rounded-r-none bg-yellow-300"></div>
            <div class="w-3/12 h-2 bg-purple-300 border-l border-white"></div>
            <div class="w-1/12 h-2 bg-red-300 border-l border-white"></div>
          </div>
    ...
    <!-- 底部 -->
    <footer
      class="container mx-auto text-xs border-t border-gray-300 py-10 flex flex-col lg:flex-row items-center justify-between">
      ...
      <div class="hidden lg:block">
        <svg class="w-6 fill-current text-gray-400 hover:text-gray-600" aria-hidden="true" viewBox="0 0 16 16"
          version="1.1" data-view-component="true">
          <path fill-rule="evenodd"
            d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z">
          </path>
